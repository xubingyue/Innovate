...
void DCAgent::openAdTracking()
{
	[DEAgent openAdTracking];
}

void DCTracking::setEffectPoint(const char* pointId, map<string, string>* map)
{
	NSString* objcPointId = [NSString stringWithCString:pointId encoding:NSUTF8StringEncoding];
	...
	[DETracking setEffectPoint:objcPointId propDictionary:dictionary];
}
...
void DCVirtualCurrency::paymentSuccess(const char* orderId, const char* iapId, double currencyAmount, const char* currencyType, const char* paymentType)
{
	...
	[DEVirtualCurrency paymentSuccess:objcOrderId iapId:objcIapId currencyAmount:currencyAmount currencyType:objcCurrencyType paymentType:objcPaymentType];
}
...
void DCVirtualCurrency::paymentSuccessInLevel(const char* orderId, const char* iapId, double currencyAmount, const char* currencyType, const char* paymentType, const char* levelId)
{
    ...
    [DEVirtualCurrency paymentSuccessInLevel:objcOrderId iapId:objcIapId currencyAmount:currencyAmount currencyType:objcCurrencyType paymentType:objcPaymentType levelId:objcLevelId];
}
...
void DCCardsGame::play(const char* roomId, const char* roomType, const char* coinType, long long lostOrGainCoin, long long taxCoin, long long leftCoin)
{
    ...
    [DECardsGame play:objcRoomId roomType:objcLabel coinType:objcCoinType lostOrGainCoin:lostOrGainCoin taxCoin:taxCoin leftCoin:leftCoin];
}
...
void DCCardsGame::lost(const char* roomId, const char* roomType, const char* coinType, long long lostCoin, long long leftCoin)
{
    ...
    [DECardsGame lost:objcRoomId roomType:objcReason coinType:objcCoinType lostCoin:lostCoin leftCoin:leftCoin];
}
...
void DCCardsGame::gain(const char* roomId, const char* roomType, const char* coinType, long long gainCoin, long long leftCoin)
{
    ...
    [DECardsGame gain:objcRoomId roomType:objcReason coinType:objcCoinType gainCoin:gainCoin leftCoin:leftCoin];
}
