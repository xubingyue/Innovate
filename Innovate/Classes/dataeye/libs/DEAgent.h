...
@interface DETracking : NSObject

extern NSString* const POINT_DEVICE_ACTIVE;
extern NSString* const POINT_ACCOUNT_LOGIN;
extern NSString* const POINT_ACCOUNT_CREATE;
extern NSString* const POINT_PAYMENT;
extern NSString* const POINT_ROLE_CREATE;
extern NSString* const POINT_SDK_INIT;
